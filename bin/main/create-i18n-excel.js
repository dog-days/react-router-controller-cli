...
class ReadAndGenerateLocaleExeclList {
  constructor(config) {
    ...
    this.langList = [['position', config.language || 'zh_CN']];
    //不重复的语言文案列表
    this.uniqueLangList = [];
    //和excel比较后语言文案列表
...
module.exports = function(config) {
  var obj = new ReadAndGenerateLocaleExeclList(config);
